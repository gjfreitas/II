...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        BackgroundImage = Image.FromFile("C:\Users\freit\OneDrive - Universidade de Aveiro\Mestrado\4 ano\2 Semestre\II\Prática\Aula 1\ua-top-1.jpg") 'Esta passa a ser a imagem de fundo da janela Form1
        'BackgroundImageLayout = ImageLayout.Stretch
        Height = 250 'A janela Form1 ocupa Height por Width pixeis no écran
        Width = 600
        Icon = New Icon("C:\Users\freit\OneDrive - Universidade de Aveiro\Mestrado\4 ano\2 Semestre\II\Prática\Aula 1\ua-favicon.ico") ' Esta imagem "icon" aparece no canto superior da janela Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            TextBox3.Text = "Erro! Formato errado"
        End If
    End Sub
End Class
